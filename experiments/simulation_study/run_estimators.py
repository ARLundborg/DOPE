...
import experiments.simulation_study.sim_estimators as es
import numpy as np
import pandas as pd
from tqdm import tqdm

n_reps = 900
n_samples = [2700, 900, 300]
d_list = [12]
links = ["lin", "sqr", "cbrt", "sin"]
clfs = ["Logistic"]
joint_regression = [False, True]
...
sim_df.to_pickle(
    "experiments/simulation_study/results/simulation_study_results.pkl"
)
